...
public class StartServer {
    ...
    public static void main(String[] args) {
        ...
        RepoCuvant repoCuvant = new RepoCuvant(serverProps);
        ...
        RepoJucatorGame repoJucatorGame = new RepoJucatorGame(serverProps, repoGame, playerRepo);

        IServices servicesImplementation = new ServiceImplementation(playerRepo, repoCuvant, repoGame, repoJucatorGame, HIBERNATE);
