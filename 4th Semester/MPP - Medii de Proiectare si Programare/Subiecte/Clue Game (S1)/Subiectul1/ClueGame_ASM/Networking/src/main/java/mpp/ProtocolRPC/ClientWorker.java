...
public class ClientWorker implements Runnable, IObserver {
    ...
    private Response handleGET_ALL_JUCATORI_GAMES(Request request) {
    ...
    private Response handleSAVE_CONFIGURATIE(Request request) {
        ...
        Configuratie savedConfiguratie = null;
        try {
            savedConfiguratie = service.saveConfiguratie(configuratie);
        } catch (GenericException e) {
            throw new RuntimeException(e);
        }
        Response response = new Response(ResponseType.OK, savedConfiguratie);
        return response;
    }
    ...
    private Response handleSAVE_JUCATOR_GAME(Request request) {
        ...
        try {
            savedJucatorGame = service.saveJucatoriGames(jucatorGame);
        } catch (GenericException e) {
            throw new RuntimeException(e);
        }
        Response response = new Response(ResponseType.OK, savedJucatorGame);
        return response;
    }
