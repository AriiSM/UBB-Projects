...
public class ThreadOrizontala {
    static class MyThread extends Thread {
        ...
        public MyThread(int[][] F_padded, int[][] C, int[][] V, int startRow, int endRow, int[][] matrixThread) {
    ...
    public static void main(String[] args) {
        ...
        V = Convolutie.convolutieOrizontala(F_padded, C, n, m, numThreads);
