...
public class ThreadBloc {
    static class MyThread extends Thread {
        ...
        public MyThread(int[][] F_padded, int[][] C, int[][] V, int startRow, int endRow, int startCol, int endCol, int[][] matrixThread) {
    ...
    public static void main(String[] args) {
        ...
        V = Convolutie.convolutieBloc(F_padded, C, n, m, numThreads);
