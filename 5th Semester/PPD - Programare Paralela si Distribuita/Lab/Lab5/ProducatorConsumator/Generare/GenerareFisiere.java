...
public class GenerareFisiere {
    ...
    private static final int NUMAR_TARI = 5; // Trei tari
    ...
    private static void creeazaFisierDacaNuExista(String tara, int problema, int startID, int numarConcurenti) throws IOException {
        ...
        String folderPath = "D:\\Ariana\\Facultate\\SEM5\\PPD\\LAB\\Lab5\\ProducatorConsumator\\src\\main\\java\\ppd\\data"; // Folderul în care se vor salva fișierele
